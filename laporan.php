<div class="page-header">
    ...
    <center>
        <!-- Menambahkan target="_blank" agar membuka halaman di tab baru -->
        <p><a class="btn btn-default" target="_blank" href="cetakk.php"><span class="glyphicon glyphicon-print"></span> Cetak</a></p>
    </center>
</div>
