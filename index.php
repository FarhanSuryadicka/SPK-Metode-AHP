...
<body>
  <nav class="nav-collapse bg-primary">
    <div class="container">
      <h3 align="center">SPK METODE AHP PENILAIAN PENGANGKATAN KARYAWAN TETAP</h3>
    </div>
  </nav>
    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li><a href="?m=laporan"><span class="glyphicon glyphicon-th-large"></span> Laporan</a></li>
          <li class="dropdown">
